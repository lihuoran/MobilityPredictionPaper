...
def read_data(tag, size, n_location, seqlimit=None):
    ...
    for line in fin:
        ...
        nextloc = next_longest_loc(n_location, l1, t1, l2, t2)
        if nextloc == None:
            continue
...
def main(args):
    ...
    # read data
    seqlimit = 100
    train_x, train_y = read_data('train', args.granularity, args.n_location, seqlimit)
    valid_x, valid_y = read_data('validation', args.granularity, args.n_location, seqlimit)
    test_x, test_y = read_data('test', args.granularity, args.n_location, seqlimit)
